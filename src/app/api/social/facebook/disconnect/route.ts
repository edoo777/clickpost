...
import { deleteConnection } from "@/lib/facebook/connections";
...
export async function POST(request: Request) {
  ...
  if (row.platform !== "facebook") return errorResponse("invalid_request", "Ce compte n'est pas un compte Facebook.", 400);
