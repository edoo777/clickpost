...
import { deleteConnection } from "@/lib/tiktok/connections";
...
export async function POST(request: Request) {
  ...
  if (row.platform !== "tiktok") return errorResponse("invalid_request", "Ce compte n'est pas un compte TikTok.", 400);
