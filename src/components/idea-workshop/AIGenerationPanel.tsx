  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-border bg-surface p-5  ">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h2 className="text-sm font-semibold text-foreground ">Génération assistée</h2>
        <span className="text-xs text-muted-foreground ">Simulation déterministe, sans IA réelle</span>
      </div>
