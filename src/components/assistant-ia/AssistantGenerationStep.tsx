...
interface AssistantGenerationStepProps {
  brand: BrandProfile;
...
export function AssistantGenerationStep({
  brand,
  weekPlan,
  themes,
  onBack,
        ...
        <>
          ...
          <div className="flex max-h-96 flex-col gap-3 overflow-y-auto">
            {grouped.map(([dateKey, dayPreviews]) => (
              <div
                key={dateKey}
                className="flex flex-col gap-2 rounded-lg border border-black/[.06] p-3 dark:border-white/[.06]"
              >
