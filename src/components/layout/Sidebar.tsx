...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex h-screen w-72 shrink-0 flex-col bg-[#0e0a1a] transition-transform duration-200 ease-out lg:static lg:w-64 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex flex-col gap-1.5 border-t border-white/[.06] px-5 py-4">
          <label className="text-[11px] font-medium uppercase tracking-wide text-white/30">Connecté en tant que</label>
          <select
            value={currentUserId}
