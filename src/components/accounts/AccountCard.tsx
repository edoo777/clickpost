...
export function AccountCard({ account, scheduledPostsCount, onClick }: AccountCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex flex-col gap-3 rounded-xl border border-black/[.08] bg-white p-4 text-left transition-colors hover:border-black/[.16] dark:border-white/[.08] dark:bg-zinc-950 dark:hover:border-white/[.16]"
    >
