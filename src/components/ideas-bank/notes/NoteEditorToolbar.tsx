...
/**
 * Barre d'outils de l'éditeur de notes — copie volontaire de EditorToolbar.tsx (Atelier) avec
 * l'ajout du bouton Souligné, plutôt qu'une modification du fichier de l'Atelier (contrainte :
 * ne pas toucher l'Atelier existant). Le reste du comportement est identique.
 */
export function NoteEditorToolbar({ editor }: NoteEditorToolbarProps) {
  ...
  return (
    ...
    >
      ...
      <ToolbarButton active={state.underline} label="Souligné" onClick={() => editor.chain().focus().toggleUnderline().run()}>
